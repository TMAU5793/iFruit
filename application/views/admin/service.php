<div class="content-wrapper">
   ...
   <div class="content-header">
      <div class="container">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0 text-dark">ข้อมูลบริการ</h1></h1>
            </div>
   ...
   <section class="content pb-5">
      <div class="container">
         <form id="frm_submit" action="<?php echo base_url('admin/Service/update'); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
               <label for="">รูป</label>
               <small class="d-block mb-2">*ขนาดรูปที่แนะนำ 760 x 780 px</small>
